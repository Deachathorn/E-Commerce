  ...
  <div v-if="user && user.role === 'admin'">
    <div class="columns is-mobile">
        <div class="column is-12 has-text-centered">
            <h1 class="title is-size-3">Add Category</h1>
        </div>
    </div>
                    ...
                    <div class="content">
                        <form enctype="multipart/form-data" @submit.prevent="addCategory()">
                            ...
                            <div class="field px-4 py-2">
                                ...
                                <span v-if="v$.categoryImage.$error" class="has-text-centered">
                            ...
                            <div class="field px-4 pb-3">
                                <div class="control">
                                    <button class="button is-link is-fullwidth">Add Category</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    methods:{
        ...
        addCategory(){
            ...
            if(!this.v$.$invalid){
                ...
                axios.post('/admin/category/add', formData)
                .then(res => {
